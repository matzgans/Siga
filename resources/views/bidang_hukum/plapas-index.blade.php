...
<div class="col-md-12 col-12 mb-2">
    ...
    <div class="card">
        <div class="card-body">
            ...
            @endif
            <p class="card-title">Data Penghuni Lapas</p>
                        ...
                        @foreach($data as $value=>$item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('plapas.edit', $item->id) }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('plapas.store') }}" method="post" class="row" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-12 col-12 mb-2">
                        ...
                        <div class="col-md-12 col-12 mb-2">
                            ...
                            <select class="form-select" name="tahanan_id" id="tahanan_id" aria-label="Default select example">
                                <option selected>Pilih Jenis</option>
                                @foreach ($tahanan as $item)    
                                    <option value="{{$item->id}}">{{$item->jenis_tahanan}}</option>
                                @endforeach
                            </select>
                        </div>
...
<script>
    ...
    $('.delete').click( function(){
        ...
        .then((willDelete) => {
        if (willDelete) {
            window.location="/plapas/destroy/"+delete_id+""
