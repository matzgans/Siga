                ...
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="pills-kematianIbu-tab" data-bs-toggle="pill"
                            ...
                            aria-controls="pills-kematianIbu" aria-selected="true">Index Pembangunan Gender</button>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-kematianIbu" role="tabpanel"
                        ...
                        <h5 class="">Index Pembangunan Gender</h5>
                        <a href="{{route('ipha.cetak')}}" class="btn btn-primary m-2"><i class="fa-solid fa-print"></i> Cetak Data</a>
