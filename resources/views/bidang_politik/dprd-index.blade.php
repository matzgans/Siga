...
<div class="col-md-12 col-12 mb-2">
    ...
    <div class="card">
        <div class="card-body">
            ...
            @endif
            <p class="card-title">Data DPRD Menurut Komisi Dan Jenis Kelamin</p>
                        ...
                        @foreach($data as $value=>$item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('dprd.edit', $item->id) }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('dprd.store') }}" method="post" class="row" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="col-md-6 col-12 mb-2">
                            ...
                            <select class="form-select" name="komisi" id="komisi" aria-label="Default select example" required>
                                <option selected>Pilih Komisi</option>
...
<script>
    ...
    $('.delete').click( function(){
        ...
        .then((willDelete) => {
        if (willDelete) {
            window.location="/dprd/destroy/"+delete_id+""
