...
<div class="col-md-12 col-12">
    <div class="card">
        <div class="card-body">
            <form action="{{ route('dprd.update',$data->id) }}" method="post" class="row" enctype="multipart/form-data">
                @csrf
                <div class="col-md-12 col-12 mb-2">
                    <label for="komisi" class="form-label">Komisi</label>
                    <input type="text" class="form-control" id="komisi" value="{{$data->komisi}}" required readonly>
                </div>
