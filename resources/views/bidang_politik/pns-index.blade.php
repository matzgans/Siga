...
<div class="col-md-12 col-12 mb-2">
    ...
    <div class="card">
        <div class="card-body">
            ...
            @endif
            <p class="card-title">Data Jumlah PNS Menurut jenis kelamin</p>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('pns.store') }}" method="post" class="row" enctype="multipart/form-data">
                        @csrf
...
<script>
    ...
    $('.delete').click( function(){
        ...
        .then((willDelete) => {
        if (willDelete) {
            window.location="/pns/destroy/"+delete_id+""
