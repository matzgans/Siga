...
<div class="col-md-12 col-12 mb-2">
    ...
    <div class="card">
        <div class="card-body">
            ...
            @endif
            <p class="card-title">Jumlah Kekerasan terhadap Perempuan dan Anak</p>
                    ...
                    <tbody>
                        @foreach ($data as $value=>$item)
                            <tr>
                                ...
                                <td>{{$item->ket}}</td>
                                <td>
                                    <a href="{{ route('jumkekerasan.destroy', $item->id) }}"
                                        class="btn btn-danger btn-sm rounded-circle"><i
                                            class="ri ri-delete-bin-line"></i></a>
                                    <a href="{{ route('jumkekerasan.edit', $item->id) }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('jumkekerasan.store') }}" method="post" class="row" enctype="multipart/form-data">
                        @csrf
