...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ $active != 'dashboard' ? 'collapsed' : 'active' }} "
            ...
            <li class="nav-item">
                <a class="nav-link {{ $active != 'desa' ? 'collapsed' : 'active' }}" href="{{route('desa.index')}}">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th scope="row"><a href="#"><img
                                                            src="{{ asset('assetsAdmin') }}/img/product-1.jpg"
                                                            alt=""></a></th>
                                            ...
                                            <tr>
                                                <th scope="row"><a href="#"><img
                                                            src="{{ asset('assetsAdmin') }}/img/product-2.jpg"
                                                            alt=""></a></th>
                                            ...
                                            <tr>
                                                <th scope="row"><a href="#"><img
                                                            src="{{ asset('assetsAdmin') }}/img/product-3.jpg"
                                                            alt=""></a></th>
                                            ...
                                            <tr>
                                                <th scope="row"><a href="#"><img
                                                            src="{{ asset('assetsAdmin') }}/img/product-4.jpg"
                                                            alt=""></a></th>
                                            ...
                                            <tr>
                                                <th scope="row"><a href="#"><img
                                                            src="{{ asset('assetsAdmin') }}/img/product-5.jpg"
                                                            alt=""></a></th>
