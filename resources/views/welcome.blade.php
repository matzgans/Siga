        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Kesehatan</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li class="dropdown"><a href=""><span>Kematian Ibu Hamil</span> <i class="bi bi-chevron-down"></i></a>
                <ul>
          ...
          <li class="dropdown"><a href="#"><span>SDA Lingkukan</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          ...
          <p class="text-white">Data terpilah Gender dan Anak di Jawa Barat berfungsi untuk memotret tingkat keberhasilan pembangunan pemberdayaan perempuan, perlindungan perempuan dan anak melalui strategi Pengarusutamaan Gender (PUG) dan Pengarusutamaan Hak Anak (PUHA).</p>
